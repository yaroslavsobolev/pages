...
и [BBC](https://www.bbc.com/russian/features-53271744). 
 ...
 человеку, знакомый с программированием, а может быть даже заметной части юзеров MS Excel. 
 Для такой проверки читателю достаточно вникнуть скачать официальные данные с сайта ЦИК,
...
графе 
"Да", с 
соответсвующим увеличением на тысячу в графах "Число бюллетеней, выданных участникам" и "Число бюллетеней, 
содержащихся в ящиках для голосования". Почему именно 
...
всегда заключает, что произошла добросовестная описка ("техническая ошибка") — мол, "вместо нолика случайно написали
 единичку, с кем не бывает?" — и члены комиссии признаются невиновными. И точно: в этом случае Председатель 
