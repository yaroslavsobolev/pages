...
* Может быть переписывание протоколов по всей стране управлялось централизованно самим ЦИК, но управлялось халтурно: 
чтобы достичь 
...
одной цифры). При этом они могли и не осознавать, что помещения для голосования разных УИК иногда находятся в 
одном и том же доме. Спускали ли они в сами УИК команду переписывать протоколы для соответствия новым 
...
только на 61 
избирательных участках в целом по России. В России таких случаев как минимум в несколько раз больше. Я приведу 
аналогию: 
если в 
...
не посчитали те пары близнецов, в которых от ДТП умерли оба близнеца. В случае с УИКами и голосованием, УИК-ов-близесли 
тысяча 
голосов "Да" была приписана сразу на всех УИКах в одном доме, эти дома не попали в мои сети — и это сильно снижает 
число число попавшихся, если принять во внимание что в сумме по стране было подброшено как минимум 20 миллионов 
фальшивых 
