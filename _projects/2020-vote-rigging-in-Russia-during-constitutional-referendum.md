...
Посмотреть и потрогать эту визуализацию целиком — можно [здесь](https://popravke.net/anomalies.html).*
 ...
 Идея этой визуализации у неё примерно та же, что и у 
 ["диаграмм Габдульвалеева"](https://www.electoral.graphics/ru-ru/laboratory/gab), только выполнена она намного 
